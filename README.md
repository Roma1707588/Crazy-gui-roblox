...
local Window = Library.CreateLib("Crazy Gui by Romanizam v1.0", "RJTheme8")

local Tab = Window:NewTab("Main")

local Section = Tab:NewSection("Main scripts")

Section:NewButton("Ban hammer", "Xd", function()
    loadstring(game:HttGet("https://github.com/retpirato/Roblox-Scripts/blob/master/Ban%20Hammer.lua"))()
end)


Section:NewButton("R6", "LOL", function()
    --[[
...
Section:NewSlider("Speed", ":)", 500, 0, function(s) -- 500 () | 0 ()
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = s
end)

Section:NewButton("Fly", "i can fly but i can die:)", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/XNEOFF/FlyGuiV3/main/FlyGuiV3.txt"))()
end)


Section:NewButton("Infinite jump", "i can jump finaly", function()
    game.Workspace.Gravity = 52
end)


Section:NewTextBox("HipHeight", "WOW", function(txt)
      game:GetService("Workspace")["Your username"].Humanoid.HipHeight = txt
end)
...
Section:NewButton("Grab knife", "kill your enemy", function()
...
Section:NewButton("Tomas", "The Dank Engien", function()
...
Section:NewButton("John Doe", "...", function()
    ------------
--John Doe--
------------
-----by-----
...
Section:NewButton("Music", "", function()
    getglobal workspace
getglobal Instance
getfield -1 new
pushstring Sound
...
Section:NewButton("invisible", "you see me bro?", function()
...
Section:NewButton("Brookhaven gui", "troll players:)", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/RFR-R1CH4RD/Loader/main/Salvatore.lua"))()
end)


Section:NewButton("Lalol Hab Backdor Scanner", "SERVERSIDE", function()
...
local Tab = Window:NewTab("About Romanizam")


Section:NewButton("Romanizam is an exploiter who started hacking Roblox games in the spring of 2025", "2025", function()
    print("Clicked")
end)


Section:NewButton("My team of exploiters and I have hacked games like Natural Disaster Survival, Work at a Pizza Place and Brookhaven rp.", "we are best exploiters team in 2025", function()
    print("Clicked")
end)
...
Section:NewButton("then we found a backdoor and hacked games through it", "SERVERSIDE!!!", function()
    print("Clicked")
end)



Section:NewButton("but I also had a story in 2014 when I was hacking games with team c00lkidd", "Romanizam old 100%", function()
    print("Clicked")
end)
...
Section:NewButton("I was an og exploiter then.", "i old 100%", function()
    print("Clicked")
end)
...
Section:NewButton("also right now I am a member of the team c00lkidd 3 group", "xD", function()
    print("Clicked")
end)
...
Section:NewButton("I made this gui myself 
and I will release new versions of this gui", "lol", function()
    print("Clicked")
end)
